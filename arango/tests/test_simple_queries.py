...
class SimpleQueriesTest(unittest.TestCase):
    ...
    def test_delete_by_example(self):
        self.col.bulk_import([
            {"name": "test_doc_01", "value": 1},
            {"name": "test_doc_02", "value": 1},
            {"name": "test_doc_03", "value": 3}
        ])
        self.col.delete_by_example({"value": 1})
        self.col.delete_by_example({"value": 2})
        self.assertEqual(
    ...
    def test_delete_by_keys(self):
        ...
        self.assertEqual(
            self.col.delete_by_keys(["key01", "key03", "key06"]),
            {"removed": 3, "ignored": 0}
        )
